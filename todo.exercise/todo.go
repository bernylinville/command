...
func (l *List) String() string {
	...
	for k, t := range *l {
		...
		// Adjust the item number k to print numvers starting from 1 instead of 0
...
func (l *List) Verbose() string {
	...
	for k, t := range *l {
		...
		// Adjust the item number k to print numvers starting from 1 instead of 0
		verbose += fmt.Sprintf("%s%d: %s, created at %s, completed at %s\n", prefix, k+1, t.Task, t.CreatedAt, t.CompletedAt)
	}
...
func (l *List) HideCompleted() string {
	hide := ""
